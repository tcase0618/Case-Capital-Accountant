...
CANONICAL_MAPPINGS = [
    ...
    MappingRuleDefinition(
        ...
        priority=100,
        confidence="HIGH",
        rationale="ASC 606 contract revenue",
    ),
    MappingRuleDefinition(
        taxonomy="us-gaap",
    ...
    MappingRuleDefinition(
        taxonomy="us-gaap",
        source_concept="StockholdersEquityIncludingPortionAttributableToNoncontrollingInterest",
        canonical_concept_code="CC_SHAREHOLDERS_EQUITY",
        priority=100,
        confidence="HIGH",
    ...
    MappingRuleDefinition(
        ...
        priority=100,
        confidence="HIGH",
        rationale="IFRS gross profit",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="OperatingProfitLoss",
        canonical_concept_code="CC_OPERATING_INCOME",
        priority=100,
        confidence="HIGH",
        rationale="IFRS operating profit or loss",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="FinanceCosts",
        canonical_concept_code="CC_INTEREST_EXPENSE",
        priority=100,
        confidence="HIGH",
        rationale="IFRS finance costs",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="IncomeTaxExpenseContinuingOperations",
        canonical_concept_code="CC_INCOME_TAX_EXPENSE",
        priority=100,
        confidence="HIGH",
        rationale="IFRS continuing income tax expense",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="ProfitLoss",
        canonical_concept_code="CC_NET_INCOME",
        priority=100,
        confidence="HIGH",
        rationale="IFRS profit or loss",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="AccountingProfit",
        canonical_concept_code="CC_NET_INCOME",
        priority=95,
        confidence="HIGH",
        rationale="IFRS accounting profit",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="Assets",
    ...
    MappingRuleDefinition(
        ...
        priority=100,
        confidence="HIGH",
        rationale="IFRS current assets",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="CashAndCashEquivalents",
        canonical_concept_code="CC_CASH",
        priority=100,
        confidence="HIGH",
        rationale="IFRS cash and cash equivalents",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="TradeAndOtherCurrentReceivables",
        canonical_concept_code="CC_ACCOUNTS_RECEIVABLE",
        priority=100,
        confidence="HIGH",
        rationale="IFRS trade and other receivables",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="Inventories",
        ...
        priority=100,
        confidence="HIGH",
        rationale="IFRS inventories",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="PropertyPlantAndEquipment",
        canonical_concept_code="CC_PPE",
        priority=100,
        confidence="HIGH",
        rationale="IFRS property plant and equipment",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="Goodwill",
        ...
        priority=100,
        confidence="HIGH",
        rationale="IFRS goodwill",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="IntangibleAssetsOtherThanGoodwill",
        canonical_concept_code="CC_INTANGIBLE_ASSETS",
        priority=100,
        confidence="HIGH",
        rationale="IFRS intangible assets excluding goodwill",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="Liabilities",
        ...
        priority=100,
        confidence="HIGH",
        rationale="IFRS total liabilities",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        ...
        priority=100,
        confidence="HIGH",
        rationale="IFRS current liabilities",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="BorrowingsCurrent",
        canonical_concept_code="CC_SHORT_TERM_DEBT",
        priority=100,
        confidence="HIGH",
        rationale="IFRS current borrowings",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="BorrowingsNoncurrent",
        canonical_concept_code="CC_LONG_TERM_DEBT",
        priority=100,
        confidence="HIGH",
        rationale="IFRS noncurrent borrowings",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="LeaseLiabilities",
        canonical_concept_code="CC_LEASE_LIABILITIES",
        priority=100,
        confidence="HIGH",
        rationale="IFRS lease liabilities",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="Equity",
        ...
        priority=100,
        confidence="HIGH",
        rationale="IFRS equity",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="NetCashFlowsFromUsedInOperatingActivities",
        canonical_concept_code="CC_OPERATING_CASH_FLOW",
        priority=100,
        confidence="HIGH",
        rationale="IFRS operating cash flow",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="NetCashFlowsFromUsedInInvestingActivities",
        canonical_concept_code="CC_INVESTING_CASH_FLOW",
        priority=100,
        confidence="HIGH",
        rationale="IFRS investing cash flow",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="NetCashFlowsFromUsedInFinancingActivities",
        canonical_concept_code="CC_FINANCING_CASH_FLOW",
        priority=100,
        confidence="HIGH",
        rationale="IFRS financing cash flow",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="PurchaseOfPropertyPlantAndEquipmentClassifiedAsInvestingActivities",
        canonical_concept_code="CC_CAPITAL_EXPENDITURES",
        priority=100,
        confidence="HIGH",
        rationale="IFRS capex investing cash outflow",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="DepreciationAmortisationAndImpairmentExpense",
        canonical_concept_code="CC_DEPRECIATION_AMORTIZATION",
        priority=100,
        confidence="HIGH",
        rationale="IFRS depreciation amortisation and impairment",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="DividendsPaidClassifiedAsFinancingActivities",
        canonical_concept_code="CC_DIVIDENDS",
        priority=100,
        confidence="HIGH",
        rationale="IFRS dividends paid",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        ...
        priority=100,
        confidence="HIGH",
        rationale="IFRS weighted average basic shares",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        ...
        priority=100,
        confidence="HIGH",
        rationale="IFRS weighted average diluted shares",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="BasicEarningsLossPerShare",
        canonical_concept_code="CC_EPS",
        priority=100,
        confidence="HIGH",
        rationale="IFRS basic EPS",
    ),
    MappingRuleDefinition(
        taxonomy="ifrs-full",
        source_concept="DilutedEarningsLossPerShare",
        canonical_concept_code="CC_EPS_DILUTED",
        priority=100,
        confidence="HIGH",
        rationale="IFRS diluted EPS",
    ),
    # ========== SHARES & METRICS ==========
    # Shares Outstanding
    MappingRuleDefinition(
